...
#
# Tags look like `v<qBittorrent version>-<release>`:
#
# - if defaults/main.yml points at a qBittorrent version that has never been
#   released, the release counter restarts at 0 (`v5.2.1-0`)
# - otherwise the counter is incremented (`v5.2.1-1`), but only if something
